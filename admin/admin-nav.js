(function () {
  ...
  style.textContent = [
    ...
    '.sg-admin-nav a.sg-nav-home{color:#C8C8C8;font-size:10px;letter-spacing:3px;text-transform:uppercase;font-weight:700;text-decoration:none;white-space:nowrap;padding-right:16px;flex-shrink:0;}',
